...
latex_documents = [
    (master_doc, 'Pynspect.tex', u'Pynspect - Python data inspection library - Documentation',
     u'Jan Mach', 'manual'),
]
...
man_pages = [
    (master_doc, 'pynspect', u'Pynspect - Python data inspection library - Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Pynspect', u'Pynspect - Python data inspection library - Documentation',
     author, 'Pynspect', 'One line description of project.',
     'Miscellaneous'),
]
